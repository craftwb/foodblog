    ...
    <div class="container">
        <div class="row container-post">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="post-container">
                    <div class="post-content no-padding">
                        <img src="/frontend/img/img01.jpg" alt="danish personal blog template">
                    </div>
                    <div class="post-content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <div class="col-md-4 col-sm-6">
                <div class="post-container">
                    <div class="post-content">
                        <img src="/frontend/img/img02.jpg" alt="danish personal blog template">
                        <div class="heading-title heading-small">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="post-container">
                    <div class="post-content">
                        <img src="/frontend/img/img04.jpg" alt="danish personal blog template">
    ...
    <ul class="list-unstyled container-portfolio">
        <li>
            <div class="portfolio-item">
                <div class="portfolio-img" style="background: url(/frontend/img/img01.jpg);"></div>
        ...
        <li>
            <div class="portfolio-item">
                <div class="portfolio-img" style="background: url(/frontend/img/img02.jpg);"></div>
                <div class="portfolio-caption">
                    <div class="portfolio-text">
                        <h3>Portfolio Title /</h3>
                        <p>Short Description About Portfolio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus.</p>
        ...
        <li>
            <div class="portfolio-item">
                <div class="portfolio-img" style="background: url(/frontend/img/img03.jpg);"></div>
                <div class="portfolio-caption">
                    <div class="portfolio-text">
                        <h3>Portfolio Title /</h3>
                        <p>Short Description About Portfolio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus.</p>
        ...
        <li>
            <div class="portfolio-item">
                <div class="portfolio-img" style="background: url(/frontend/img/img04.jpg);"></div>
                <div class="portfolio-caption">
                    <div class="portfolio-text">
                        <h3>Portfolio Title /</h3>
                        <p>Short Description About Portfolio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus.</p>
        ...
        <li>
            <div class="portfolio-item">
                <div class="portfolio-img" style="background: url(/frontend/img/img05.jpg);"></div>
                <div class="portfolio-caption">
                    <div class="portfolio-text">
                        <h3>Portfolio Title /</h3>
                        <p>Short Description About Portfolio Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis lectus metus.</p>
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="list-unstyled brand-img">
                    <li>
                        <a href="#"><img src="/frontend/img/partner01.png"></a>
                    </li>
                    <li>
                        <a href="#"><img src="/frontend/img/partner02.png"></a>
                    </li>
                    <li>
                        <a href="#"><img src="/frontend/img/partner01.png"></a>
                    </li>
